...
namespace xpl {
  ...
  public:
    inline sweep_up_node(int lineno, cdk::lvalue_node* lvalue, cdk::expression_node* init, cdk::expression_node* cond, cdk::expression_node* step, cdk::basic_node* block) :
