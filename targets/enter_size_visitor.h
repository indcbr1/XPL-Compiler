#ifndef __XPL_ENTER_SIZE_VISITOR_H__
#define __XPL_ENTER_SIZE_VISITOR_H__
...
namespace xpl {
  class enter_size_visitor: public basic_ast_visitor {
  int _totalsize=0;
  public:
    enter_size_visitor(std::shared_ptr<cdk::compiler> compiler) :
