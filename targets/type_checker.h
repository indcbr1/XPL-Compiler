// $Id: type_checker.h,v 1.7 2017/05/16 23:08:11 ist181271 Exp $ -*- c++ -*-
...
namespace xpl {
  ...
  protected:
    ...
    void processBinaryExpressionI(cdk::binary_expression_node * const node, unsigned long int typeA, int typeASize, unsigned long int typeB, int typeBSize, int lvl);
    void processBinaryExpressionX(cdk::binary_expression_node * const node, unsigned long int typeA, int typeASize, unsigned long int typeB, int typeBSize, int lvl);
    void processMul(cdk::binary_expression_node * const node, int lvl);
